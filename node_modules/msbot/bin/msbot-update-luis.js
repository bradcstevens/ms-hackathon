...
async function processArgs(config) {
    ...
    for (const service of config.services) {
        if (service.type === botframework_config_1.ServiceTypes.Luis) {
            const luisService = service;
            if (luisService.id === args.id || luisService.appId === args.appId) {
                ...
                await stdioAsync_1.stdoutAsync(JSON.stringify(luisService, null, 2));
                return config;
            }
        }
    }
...
//# sourceMappingURL=msbot-update-luis.js.map