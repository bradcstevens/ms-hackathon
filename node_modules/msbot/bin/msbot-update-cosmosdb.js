...
async function processArgs(config) {
    ...
    for (const service of config.services) {
        if (service.type === botframework_config_1.ServiceTypes.CosmosDB) {
            const cosmosService = service;
            if (cosmosService.id === args.id || cosmosService.serviceName === args.serviceName) {
                ...
                await stdioAsync_1.stdoutAsync(JSON.stringify(cosmosService, null, 2));
                return config;
            }
        }
    }
...
//# sourceMappingURL=msbot-update-cosmosdb.js.map