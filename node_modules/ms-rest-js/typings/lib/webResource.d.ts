...
export declare class WebResource {
    ...
    constructor(url?: string, method?: HttpMethods, body?: any, query?: {
        ...
        [key: string]: any;
    } | HttpHeaders, rawResponse?: boolean, withCredentials?: boolean, abortSignal?: AbortSignalLike, timeout?: number, onUploadProgress?: (progress: TransferProgressEvent) => void, onDownloadProgress?: (progress: TransferProgressEvent) => void);
    /**
