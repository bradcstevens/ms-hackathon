...
var WebResource = /** @class */ (function () {
    function WebResource(url, method, body, query, headers, rawResponse, withCredentials, abortSignal, timeout, onUploadProgress, onDownloadProgress) {
    ...
    WebResource.prototype.prepare = function (options) {
        ...
        if (!this.headers.get("x-ms-client-request-id") && !options.disableClientRequestId) {
            this.headers.set("x-ms-client-request-id", utils_1.generateUuid());
        }
        // default
        ...
        if (options.body != undefined) {
            ...
            if (options.bodyIsStream) {
                ...
                if (options.serializationMapper) {
                    this.body = new serializer_1.Serializer(options.mappers).serialize(options.serializationMapper, options.body, "requestBody");
                }
    ...
    WebResource.prototype.clone = function () {
        var result = new WebResource(this.url, this.method, this.body, this.query, this.headers && this.headers.clone(), this.rawResponse, this.withCredentials, this.abortSignal, this.timeout, this.onUploadProgress, this.onDownloadProgress);
