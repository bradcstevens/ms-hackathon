            ...
            return new Promise(function (resolve, reject) {
                xhr.addEventListener("readystatechange", function () {
                    ...
                    if (xhr.readyState === XMLHttpRequest.HEADERS_RECEIVED) {
                        var bodyPromise_1 = new Promise(function (resolve, reject) {
                        ...
                        resolve({
                            ...
                            blobBody: function () { return bodyPromise_1; }
                        });
                    }
                });
                rejectOnTerminalEvent(request, xhr, reject);
...
function parseHeaders(xhr) {
    var responseHeaders = new httpHeaders_1.HttpHeaders();
...
function rejectOnTerminalEvent(request, xhr, reject) {
    xhr.addEventListener("error", function (ev) { return reject(new restError_1.RestError(ev.message, "REQUEST_SEND_ERROR", undefined, request)); });
    xhr.addEventListener("abort", function () { return reject(new restError_1.RestError("The request was aborted", "REQUEST_ABORTED_ERROR", undefined, request)); });
    xhr.addEventListener("timeout", function () { return reject(new restError_1.RestError("timeout of " + xhr.timeout + "ms exceeded", "REQUEST_SEND_ERROR", undefined, request)); });
}
