...
var AxiosHttpClient = /** @class */ (function () {
    ...
    AxiosHttpClient.prototype.sendRequest = function (httpRequest) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var formData, requestForm_1, appendFormValue, _i, _a, formKey, formValue, j, contentType, cookieString, abortSignal, abortListener, cancelToken, rawHeaders, httpRequestBody, axiosBody, onUploadProgress, totalBytes_1, loadedBytes_1, uploadReportStream, res, config, err_1, axiosErr, headers, onDownloadProgress, responseBody, totalBytes_2, loadedBytes_2, downloadReportStream, operationResponse, setCookieHeader_1;
            var _this = this;
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (onUploadProgress && axiosBody) {
                            totalBytes_1 = parseInt(httpRequest.headers.get("Content-Length")) || undefined;
                            loadedBytes_1 = 0;
                            uploadReportStream = new Transform({
                                transform: function (chunk, _encoding, callback) {
                                    loadedBytes_1 += chunk.length;
                                    onUploadProgress({ loadedBytes: loadedBytes_1, totalBytes: totalBytes_1 });
                    ...
                    case 5:
                        ...
                        if (err_1 instanceof axios.Cancel) {
                            throw new RestError(err_1.message, "REQUEST_ABORTED_ERROR", undefined, httpRequest);
                        }
                        else {
                            axiosErr = err_1;
                    ...
                    case 7:
                        ...
                        if (onDownloadProgress) {
                            totalBytes_2 = parseInt(headers.get("Content-Length")) || responseBody.length || undefined;
                            if (isReadableStream(responseBody)) {
                                loadedBytes_2 = 0;
                                downloadReportStream = new Transform({
                                    transform: function (chunk, _encoding, callback) {
                                        loadedBytes_2 += chunk.length;
                                        onDownloadProgress({ loadedBytes: loadedBytes_2, totalBytes: totalBytes_2 });
                                        callback(undefined, chunk);
                                    }
                                });
                            ...
                            else if (totalBytes_2) {
                                // Calling callback for non-stream response for consistency with browser
                                onDownloadProgress({ loadedBytes: totalBytes_2, totalBytes: totalBytes_2 });
                            }
                        }
                        operationResponse = {
                            request: httpRequest,
                            status: res.status,
                            headers: headers,
                            readableStreamBody: httpRequest.rawResponse ? responseBody : undefined,
                            bodyAsText: httpRequest.rawResponse ? undefined : responseBody
                        };
